...
module riscv(input  logic        clk, reset,
   ...
   controller c(clk, reset,
		...
		MemWriteM, RegWriteM, 
		RegWriteW, ResultSrcM, auipcSrc, MemStrobeD);
   ...
   datapath dp(clk, reset,
	       ...
	       FlushE, ForwardAE, ForwardBE, PCSrcE, ALUControlE, ALUSrcE, ZeroE, ovfE, negE, carE,
               ...
               Rs1D, Rs2D, Rs1E, Rs2E, RdE, RdM, RdW, auipcSrc, PCReady, MemStrobeD, MemStrobe);
...
module controller(input  logic		 clk, reset,
   ...
   floprc #(21) controlregE(clk, reset, FlushE,
                            {RegWriteD, ResultSrcD, MemWriteD, JumpD, BranchD, ALUControlD, ALUSrcD, funct3D, opD},
...
module datapath(input logic clk, reset,
                ...
                input logic      PCReady, MemStrobeD,
   ...
   flopenrc #(96) regD(clk, reset, FlushD, ~StallD | PCReady, 
                       {InstrF, PCF, PCPlus4F},
                       {InstrD, PCD, PCPlus4D});
   ...
   flopr  #(138) regM(clk, reset, // added 32 bits for immext
                      {ALUResultE, WriteDataE, RdE, PCPlus4E, ImmExtE, funct3E, ALUSrcE, MemStrobeE},
                      {ALUResultM, WriteDataM, RdM, PCPlus4M, ImmExtM, funct3M, ALUSrcM, MemStrobeM});
