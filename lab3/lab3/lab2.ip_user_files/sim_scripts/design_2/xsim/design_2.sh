...
#
# Script generated by Vivado on Tue Apr 15 15:08:40 CDT 2025
...
# set xvlog options
xvlog_opts="--incr --relax  -L axi_vip_v1_1_15 -L smartconnect_v1_0 -L axi_vip_v1_1_8 -L processing_system7_vip_v1_0_17 -L axi_vip_v1_1_5 -L processing_system7_vip_v1_0_7 -L xilinx_vip"

# script info
echo -e "design_2.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_2 xil_defaultlib.design_2 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim design_2 -key {Behavioral:sim_1:Functional:design_2} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_afc3.protoinst" -protoinst "protoinst_files/design_2.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/opt/Xilinx/Vivado/2023.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb design_2.wdb xsim.dir libdpi.so)
