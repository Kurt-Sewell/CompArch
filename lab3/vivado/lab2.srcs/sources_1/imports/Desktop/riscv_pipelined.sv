...
module riscv(input  logic        clk, reset,
   ...
   controller c(clk, reset,
		...
		FlushE, ZeroE, ovfE, negE, carE, PCSrcE, ALUControlE, ALUSrcE, ResultSrcEb0,
		MemWriteM, RegWriteM, 
		RegWriteW, ResultSrcM, auipcSrc, MemStrobeM);

   datapath dp(clk, reset,
               StallF, PCF, InstrF,
	       opD, funct3D, funct7b5D, StallD, FlushD, ImmSrcD,
	       FlushE, ForwardAE, ForwardBE, PCSrcE, ALUControlE, ALUSrcE, ZeroE, ovfE, negE, carE,
               MemWriteM, WriteDataM, ALUResultM, ReadDataM, RegWriteM,
               RegWriteW, ResultSrcM,
               Rs1D, Rs2D, Rs1E, Rs2E, RdE, RdM, RdW, auipcSrc, PCReady);

   hazard  hu(Rs1D, Rs2D, Rs1E, Rs2E, RdE, RdM, RdW,
              PCSrcE[0], ResultSrcEb0, RegWriteM, RegWriteW,
...
module controller(input  logic		 clk, reset,
                  ...
                  input logic 	     FlushE, 
                  input logic 	     ZeroE, ovfE, negE, carE,
                  output logic [1:0] PCSrcE, // for datapath and Hazard Unit
   ...
   maindec md(opD, ResultSrcD, MemWriteD, BranchD,
              ALUSrcD, RegWriteD, JumpD, ImmSrcD, ALUOpD, auipcSrcD, MemStrobeD);
   aludec  ad(opD[5], funct3D, funct7b5D, ALUOpD, ALUControlD);
   
   // Execute stage pipeline control register and logic
   floprc #(21) controlregE(clk, reset, FlushE,
                            {RegWriteD, ResultSrcD, MemWriteD, JumpD, BranchD, ALUControlD, ALUSrcD, funct3D, opD, MemStrobeD},
                            {RegWriteE, ResultSrcE, MemWriteE, JumpE, BranchE, ALUControlE, ALUSrcE, funct3E, opE, MemStrobeE});
    

    always_comb begin
      case(funct3E)
      3'b000: BranchCondition = ZeroE;    // beq
      3'b001: BranchCondition = ~ZeroE;    // bne
      3'b100: BranchCondition = negE ^ ovfE;    // blt
      3'b101: BranchCondition = ~(negE ^ ovfE);    // bge
      3'b110: BranchCondition = ~carE;    // bltu
      3'b111: BranchCondition = carE;    // bgeu
   ...
   assign PCSrc0 = (BranchE & BranchCondition) | JumpE;
   assign PCSrcE= {PCSrc1, PCSrc0};
...
module maindec(input  logic [6:0] op,
               ...
               output logic     auipcSrc, MemStrobe);

   logic [13:0] 		  controls; // changed to add 3 bit imm and 1 bit auipc

   assign {RegWrite, ImmSrc, ALUSrc, MemWrite,
           ResultSrc, Branch, ALUOp, Jump, auipcSrc, MemStrobe} = controls; 
// change controls to 14 bits
   always_comb
     case(op)
       // RegWrite_ImmSrc_ALUSrc_MemWrite_ResultSrc_Branch_ALUOp_Jump_auipcSrc_MemStrobe
       7'b0000011: controls = 14'b1_000_1_0_01_0_00_0_0_1; // lw
       7'b0100011: controls = 14'b0_001_1_1_00_0_00_0_0_1; // sw
       ...
       7'b0110111: controls = 14'b1_100_1_0_11_0_1x_0_0_0; // lui
       7'b0010111: controls = 14'b1_100_1_0_00_0_00_0_1_0; // auipc 
       7'b1100111: controls = 14'b1_000_0_0_10_0_00_1_0_0; // jalr
       7'b0000000: controls = 14'b0_000_0_0_00_0_00_0_0_0; // need valid values at reset
...
module datapath(input logic clk, reset,
                ...
                input logic 	    ALUSrcE,
                output logic 	    ZeroE, ovfE, negE, carE,
   ...
   assign jalrTarget = SrcAE + ImmExtE;
   // Fetch stage pipeline register and logic
   mux3    #(32) pcmux(PCPlus4F, PCTargetE, jalrTarget , PCSrcE, PCNextF);
   ...
   floprc #(179) regE(clk, reset, FlushE, 
                      {RD1D0, RD2D, PCD, Rs1D, Rs2D, RdD, ImmExtD, PCPlus4D, funct3D}, 
   ...
   mux2   #(32)  srcamux(RD1D, PCD, auipcSrcD, RD1D0);

   alu           alu(SrcAE, SrcBE, ALUControlE, ALUResultE, ZeroE, ovfE, negE, carE);
   adder         branchadd(ImmExtE, PCE, PCTargetE);

   // Memory stage pipeline register
   flopr  #(138) regM(clk, reset, // added 32 bits for immext
                      {ALUResultE, WriteDataE, RdE, PCPlus4E, ImmExtE, funct3E, ALUSrcE},
                      {ALUResultM, WriteDataM, RdM, PCPlus4M, ImmExtM, funct3M, ALUSrcM});
   
   // Writeback stage pipeline register and logic
   flopr  #(139) regW(clk, reset, 
                      {ALUResultM, DataM, RdM, PCPlus4M, ImmExtM, funct3M, ALUSrcM, ResultSrcM},
                      {ALUResultW, DataW, RdW, PCPlus4W, ImmExtW, funct3W, ALUSrcW, ResultSrcW});
                      
   mux4   #(32)  resultmux(ALUResultW, DataW, PCPlus4W, ImmExtW, ResultSrcW, ResultW);

   load load (RegWriteM, ALUSrcM, ResultSrcM, funct3M, ALUResultM, ReadDataM, DataM);
   store store (MemWriteM, funct3M, ALUResultM, DataM, WriteDataM, StoreOutM);
endmodule
...
module alu(input  logic [31:0] a, b,
           ...
           output logic        zero, ovf, neg, car); // Zero, overflow , negative, carry
   ...
   assign carrySum = a + condinvb + alucontrol[0];
   ...
   assign car = carrySum[32] & (alucontrol[3:0] == 4'b0000 | alucontrol[3:0] == 4'b0001); // only turns to 1 if alucontrol is add or sub
